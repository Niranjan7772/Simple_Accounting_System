...
<html lang="en">
  ...
  <body>
    <!-- page-->
    <div class="page page_notification">
            ...
            <div class="notification__wrapper">
              <div class="notification__head">
                <form class="search" action="">
                  <input class="search__input" type="text" name="search" placeholder="Search Notification" required="required"/>
                  <button class="search__button">
                    <svg class="icon icon-search">
                      <use xlink:href="#icon-search"></use>
                    </svg>
                ...
                <div class="field field_medium field_icon-after">
                  <div class="field__wrap">
                    <input class="field__input js-date-range" type="text" name="date" data-format="MM.DD.yyyy" data-single-month="true" data-single-date="false" data-container=".field__wrap" placeholder="Range date" readonly>
              ...
              <div class="notification__list">
                ...
                <div class="notification__item">
                  ...
                  <div class="notification__details">
                    <div class="notification__line">
                      <div class="notification__subtitle">Transfer Success</div>
                      <div class="notification__time">2m</div>
                    </div>
                    <div class="notification__info">You have successfully sent <span>johnatan</span> $10.00</div>
                  </div>
                </div>
                <div class="notification__item">
                  ...
                  <div class="notification__details">
                    <div class="notification__line">
                      <div class="notification__subtitle">Transfer Success</div>
                      <div class="notification__time">30m</div>
                    </div>
                    <div class="notification__info">You have successfully sent <span>Startbucks</span> $532.11</div>
                  </div>
                </div>
