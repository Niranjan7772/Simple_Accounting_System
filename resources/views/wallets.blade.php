...
<html lang="en">
  ...
  <body>
        ...
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap"><a class="header__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
              <nav class="header__navigation"><a class="header__link" href="index.html">Dashboard</a><a class="header__link active" href="wallets.html">Wallets</a><a class="header__link" href="settings.html">Settings</a><a class="header__link" href="help-center.html">Help & Center</a></nav><a class="header__logout" href="login.html">Log Out</a>
          ...
          <div class="page__title">Wallets</div>
          <div class="page__breadcrumbs"><a class="page__link" href="wallets.html">Wallets</a>
          ...
          <div class="wallets">
            <div class="wallets__row">
              <div class="wallets__col">
                ...
                <div class="card">
                  <div class="card__head">
                    <div class="card__title">Card Lists
                      <div class="tooltip" title="Small description">
                        <svg class="icon icon-info-circle">
                          <use xlink:href="#icon-info-circle"></use>
                        </svg>
                  ...
                  <div class="card__credits">
                    <!-- credit--><a class="credit" href="wallet.html" style="background: linear-gradient(164.81deg, #2AAC95 19.8%, #76D1F7 95.93%)">
                      <div class="credit__circles"><span></span><span></span><span></span></div>
                      <div class="credit__head">
                        <div class="credit__title">Visa Card</div>
                        <div class="credit__logo"><img src="img/content/visa-card-white.svg" alt=""></div>
                      </div>
                      <div class="credit__number">****  ***** **** 3456</div>
                      <div class="credit__foot">
                        <div class="credit__box">
                          <div class="credit__text">Name</div>
                          <div class="credit__name">Rainer Yaeger</div>
                        </div>
                        <div class="credit__date">11/23</div>
                      </div></a>
                    <!-- credit--><a class="credit" href="wallet.html" style="background: linear-gradient(164.81deg, #2A6EAC 19.8%, #76D1F7 95.93%)">
                      <div class="credit__circles"><span></span><span></span><span></span></div>
                      <div class="credit__head">
                        <div class="credit__title">Master Card</div>
                        <div class="credit__logo"><img src="img/content/master-card-white.svg" alt=""></div>
                      </div>
                      <div class="credit__number">****  ***** **** 6532</div>
                      <div class="credit__foot">
                        <div class="credit__box">
                          <div class="credit__text">Name</div>
                          <div class="credit__name">Mikasa Ackerman</div>
                        </div>
                        <div class="credit__date">08/25</div>
                      </div></a>
                  </div><a class="button-stroke button-wide js-popup-open" href="#popup-add-new-card" data-type="inline" data-effect="mfp-zoom-in">Add new card</a>
                </div>
              </div>
              <div class="wallets__col">
                <!-- card-->
                <div class="card">
                  <div class="card__head">
                    <div class="card__title">Balance Analytics
                      <div class="tooltip" title="Small description">
                        <svg class="icon icon-info-circle">
                          <use xlink:href="#icon-info-circle"></use>
                        </svg>
                    ...
                    <div class="card__settings">
                      <!-- switch-->
                      <label class="switch">
                        <input class="switch__input" type="checkbox" checked><span class="switch__inner"></span><span class="switch__title">Income Statistics</span>
                      </label>
                      <!-- switch-->
                      <label class="switch">
                        <input class="switch__input" type="checkbox"><span class="switch__inner"></span><span class="switch__title">Expense Statistics</span>
                      </label>
                    </div>
                    <div class="card__right">
                      <!-- drop-->
                  ...
                  <div class="card__chart card__chart_balance-analytics">
                    <div id="balance-analytics"></div>
                  </div>
                </div>
                <div class="wallets__line">
                  <div class="wallets__cell">
                    <!-- card-->
                    <div class="card">
                      <div class="card__head">
                        <div class="card__title">Quick Transfer
                          <div class="tooltip" title="Small description">
                            <svg class="icon icon-info-circle">
                              <use xlink:href="#icon-info-circle"></use>
                            </svg>
                      ...
                      <div class="contacts">
                        <div class="contacts__wrapper">
                          <div class="contacts__list">
                            <!-- swiper-->
                            <div class="swiper swiper-contacts-four">
                        ...
                        <form class="contacts__form" action="">
                          ...
                          <div class="field field_icon-before">
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="amount" placeholder="Type input ammount" required>
                          ...
                          <button class="button contacts__button"><span>Send</span>
                  ...
                  <div class="wallets__cell">
                    ...
                    <div class="card">
                      ...
                      <div class="currency">
                        ...
                        <div class="currency__item">
                          <div class="currency__logo"><img src="img/content/japan-yen.png" alt=""/></div>
                          <div class="currency__details">
                            <div class="currency__title">Japan Yen</div>
                            <div class="currency__price">137,64</div>
                            <div class="currency__description">JPY</div>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <!-- popup-->
    <div class="popup popup_add-new-card mfp-hide" id="popup-add-new-card">
      <div class="popup__head">
        <div class="popup__title">Add New Card</div>
        <div class="popup__info">add a new card for your transaction</div>
      </div>
      <!-- credit-->
      <div class="credit" style="background: #ACB5BB">
        <div class="credit__circles"><span></span><span></span><span></span></div>
        <div class="credit__head">
          <div class="credit__title">Visa Card</div>
          <div class="credit__logo"><img src="img/content/visa-card-white.svg" alt=""></div>
      ...
      <!-- field-->
      <div class="field">
        <div class="field__label">Card Holder Name</div>
        <div class="field__wrap">
          <input class="field__input" type="text" name="card-name" placeholder="Type card holder name" required>
        </div>
      </div>
      <!-- field-->
      <div class="field">
        ...
        <div class="field__wrap">
          <input class="field__input" type="text" name="card-number" placeholder="Type card number" required>
        </div>
      </div>
      <div class="popup__line">
        <!-- field-->
        <div class="field field_icon-after">
          <div class="field__label">Expiry Date</div>
          <div class="field__wrap field__wrap_date">
            <input class="field__input js-date-range" type="text" name="expiry-date" data-format="MM/DD" data-single-month="true" data-single-date="true" data-container=".field__wrap_date" readonly>
            <div class="field__icon">
        ...
        <!-- field-->
        <div class="field">
          <div class="field__label">CVC/CVV</div>
          <div class="field__wrap">
            <input class="field__input" type="text" name="cvc-cvv" placeholder="Type CVC/CVV" required>
          </div>
        </div>
      </div>
      <button class="button-wide popup__button">Confirm</button>
