    ...
    <div class="page">
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="settings.html">Settings</a>
            ...
            <div class="page__text">Preferences</div>
          </div>
        </div>
      </div>
      <div class="page__body">
        <div class="container page__container">
          <!-- settings-->
          <div class="settings">
            <div class="settings__menu"><a class="settings__link" href="settings.html">
                ...
                <svg class="icon icon-arrow-next">
                  <use xlink:href="#icon-arrow-next"></use>
                </svg></a><a class="settings__link active" href="preferences.html">
                <div class="settings__icon">
            ...
            <div class="card">
              <div class="card__head">
                <div class="card__title">Preferences
                ...
                <div class="field">
                  ...
                  <div class="drop js-drop">
                    ...
                    <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#">
                        <div class="drop__text js-drop-text">English ( Australia )</div></a><a class="drop__option js-drop-option" href="#">
                        <div class="drop__text js-drop-text">German</div></a><a class="drop__option js-drop-option" href="#">
                        <div class="drop__text js-drop-text">French</div></a></div>
                    <input class="drop__input js-drop-input" type="hidden" name="language">
                  </div>
                </div>
                <!-- field-->
                <div class="field">
                  <div class="field__label">Color themes</div>
                  <!-- drop-->
                  <div class="drop js-drop">
                    <div class="drop__head js-drop-head">
                      <div class="drop__color js-drop-color">
                    ...
                    <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#">
                        <div class="drop__color js-drop-color" style="fill: #1C2634">
                          <svg class="icon icon-drop">
                            <use xlink:href="#icon-drop"></use>
                          </svg>
                        </div>
                        <div class="drop__text js-drop-text">Dark blue ( 1C2634 )</div></a><a class="drop__option js-drop-option" href="#">
                        <div class="drop__color js-drop-color" style="fill: #4D81E7">
                          <svg class="icon icon-drop">
                            <use xlink:href="#icon-drop"></use>
                          </svg>
                        </div>
                        <div class="drop__text js-drop-text">Blue ( 4D81E7 )</div></a><a class="drop__option js-drop-option" href="#">
                        <div class="drop__color js-drop-color" style="fill: #82AD0C">
                          <svg class="icon icon-drop">
                            <use xlink:href="#icon-drop"></use>
                          </svg>
                        </div>
                        <div class="drop__text js-drop-text">Green ( 82AD0C )</div></a></div>
                    <input class="drop__input js-drop-input" type="hidden" name="color">
                  </div>
                </div>
                <div class="settings__notifications">
                  <div class="settings__label">Notification</div>
                  <div class="settings__notification">
                    <div class="settings__box">
                      <div class="settings__title">Update Systems</div>
                      <div class="settings__content">let me know if there is a new product update</div>
                    </div>
                    <!-- switch-->
                    <label class="switch">
                  ...
                  <div class="settings__notification">
                    <div class="settings__box">
                      <div class="settings__title">Transactions</div>
                      <div class="settings__content">tell me about the information after making the transaction</div>
                    </div>
                    <!-- switch-->
                    <label class="switch">
                      <input class="switch__input" type="checkbox" checked><span class="switch__inner"></span>
                    </label>
                  </div>
                  <div class="settings__notification">
                    <div class="settings__box">
                      <div class="settings__title">Email Notification</div>
                      <div class="settings__content">notify me of all notifications via email</div>
                    </div>
                    <!-- switch-->
                    <label class="switch">
                      <input class="switch__input" type="checkbox" checked><span class="switch__inner"></span>
