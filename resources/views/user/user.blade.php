      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="index.html">Dashboard</a>
            ...
            <div class="page__text">Users</div>
          </div>
          <div class="page__line">
            ...
            <div class="page__nav"><a class="page__link " href="/d2">Overview</a><a class="page__link" href="{{ route('transaction.index') }}">Transaction</a><a class="page__link" href="statistics.html">Statistics</a><a class="page__link" href="{{ route('users.index') }}">Users</a><a class="page__link" href="{{ route('accounts.index') }}">Accounts</a><a class="page__link" href="{{ route('expense.index') }}">Expense</a><a class="page__link active" href="{{ route('budget.index') }}">Budget</a><a class="page__link" href="{{ route('customer.index') }}">Customer</a><a class="page__link" href="{{ route('invoice.index') }}">Invoice</a><a class="page__link" href="{{ route('audit.index') }}">Audit</a></div>
        ...
        <div class="container page__container">
         ...
         <div class="alert alert-danger">
            ...
            <div class="row">
                ...
                <div class="col md-1"></div>
                  <div class="col md-1">
                      <a class="page__link"  href="{{ route('budget.create') }}"> <button class="btn btn-success">Add Budget</button></a>
                  </div>
           </div>
