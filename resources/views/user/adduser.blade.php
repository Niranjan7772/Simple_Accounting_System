      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/users"><i class="fa fa-arrow-left" aria-hidden="true" style="font-size: 17px;"></i></a>
            ...
            <div class="page__text">Add Users</div>
          </div>
          <div class="page__line">
            ...
            <div class="page__nav"><a class="page__link active" href="{{ route('users.index') }}">User</a></div>
          ...
          <div class="transactions">
            ...
            <div class="col-md-6">
                   <div class="form-group">
                    <h5> <label for="phone" class="fw-bold">Phone</label></h5>
                     <input type="number" class="form-control  @error('phone') is-invalid @enderror"     name="phone" id="phone"  value="{{ old('phone')}}"    placeholder="Enter  phone">
                   </div>
                   <div>@error('phone')
                    <span style="color: red">{{ $message }}</span>
                @enderror
                                ...
                                <div class="dropdown-menu w-100" aria-labelledby="accountDropdown">
                                    @foreach ($accounts as $account)
                                        <div class="px-5 form-check">
                                            ...
                                            <label class="form-check-label" for="account{{ $account->id }}" style="font-size: 18px;">
                                                {{ $account->name }}
                                            </label>
                                        </div>
                                    @endforeach
            ...
            <div class="col-md-6">
                 ...
                 <select name="role" id="role" class="form-control">
                    ...
                    @if($role->id!==1)
                    <option value={{ $role->id }} class="form-control"  style="font-size: 18px;">{{ $role->name }}</option>
                    @endif
                  @endforeach
                 </select>
                   </div><br>
                ...
                <div class="col-md-6">
                 ...
                 <select name="status" id="status" class="form-control">
                    ...
                    <option value="0" class="form-control">disable</option>
                    <option value="1" class="form-control">enable</option>
