      ...
      <div class="page__head">
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap"><a class="header__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
                <nav class="header__navigation">
                    ...
                    @endif
                    {{-- <a class="header__logout" href="/logout">Log Out</a> --}}
                </nav>
          ...
          <div class="page__breadcrumbs">
            <a class="page__link" href="/d2">Dashboard</a>
            ...
            <div class="mt-4 col-md-1">
                ...
                <div class="row">
                    ...
                    <div class="mb-4 col md-1">
                        <a class="page__link"  href="{{ route('users.create') }}"> <button class="mb-3 btn btn-dark"><i class="fa fa-user-plus" style="font-size:20px;margin-right:5px;"></i>Add Users</button></a>
                    </div>
                    @endif
                    ...
                    <table class="table table-striped" id="myTable">
                        ...
                        <tbody id="search_list">
                                ...
                                @if($user->role_id!==1)
                                <tr>
                                <td style="font-size: 17px;">{{ $key }}</td>
                                <td style="font-size: 17px;" >{{ $user->name }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('users.edit', $user->id) }}" type="button">
                                        <i class="fa fa-pencil-square-o" style="font-size:30px;color:green" ></i>
                                      </a>
                                   @endif
                                   @if (Auth::user()->hasPermission('delete_user'))
                                   <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $user->id }}" style="cursor: pointer;">
...
$(document).ready(function () {
    ...
    // Specify the column indices you want to search (0-based indices)
    // var columnsToSearch = [1, 2, 3]; // Assuming "Name", "Email", and "Phone" are the columns to be searched

    $('#myTable_filter input').on('input', function () {
        var searchTerm = $(this).val().trim();

        // // Update the search term for the specified columns
        // columnsToSearch.forEach(function (columnIndex) {
        //     dataTable.column(columnIndex).search(searchTerm);
        // });

        // // Redraw the DataTable to apply the search
        // dataTable.draw();
