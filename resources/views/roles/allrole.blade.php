      ...
      <div class="page__head">
        <div class="container page__container">
            ...
            <div class="header__control">
              ...
              <div class="notification">
                ...
                <div class="notification__body">
                  ...
                  <a class="button-stroke button-wide" href="/notification">See more Notification</a>
                </div>
              </div>
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/d2">Dashboard</a>
            ...
            <div class="page__text">Roles</div>
          </div>
               ...
               {{ session()->get('deleted') }}
                ...
                <div class="row">
                    @if (Auth::user()->hasPermission('add_roles'))
                      <div class="col-md-1">
                          <a class="page__link"  href="{{ route('role.create') }}"> <button class="mb-3 btn btn-dark">Add Role</button></a>
                      </div>
                      @endif
               </div>
                    ...
                    <tbody >
                        ...
                        @if($row->id!==1)
                            <tr>
                                ...
                                <td style="font-size: 17px;">{{ $row['name'] }}</td>
                               <td>
                                @if (Auth::user()->hasPermission('edit_roles'))
                                <a href="{{ route('role.edit',$row->id) }}" type="button"> <i class="fa fa-pencil-square-o" style="font-size:30px;color:green" ></i></a>
                                @endif
                                   @if (Auth::user()->hasPermission('delete_roles'))
                                <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $row->id }}" style="cursor: pointer">
