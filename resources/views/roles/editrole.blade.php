    ...
    <div class="page">
      <div class="page__head">
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap"><a class="header__logo" href="index.html">
              ...
              <nav class="header__navigation">
                ...
                <a class="header__link active" href="{{ route('role.index') }}">Roles</a>
                @endif
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/role"><i class="fa fa-arrow-left" aria-hidden="true" style="font-size: 17px;"></i></a>
            <svg class="icon icon-arrow-next">
              <use xlink:href="#icon-arrow-next"></use>
            </svg>
            <div class="page__text">Edit Role</div>
          </div>
          <div class="page__line">
            <div class="page__nav"><a class="page__link active" href="{{ route('role.index') }}">Role</a></div>
              ...
              <div class="transactions__table">
                <form method="post" action="{{ route('role.update', $role->id) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <h5><label for="name" class="fw-bold">Role Name</label></h5><br>
                    ...
                    <h5><label for="name" class="fw-bold">Permissions</label></h5>
                    <div class="permissions-grid card">
                        @foreach ($permissions as $permission)
                            <div class="permission-item">
                                <input type="checkbox" id="{{ $permission->name }}" name="permissions[]" value="{{ $permission->id }}" @if($role->permissions->contains($permission->id)) checked @endif>
                                <label for="{{ $permission->name }}" class="fw-bold" style="font-size: 17px">{{ $permission->name }}</label>
                            </div>
                        @endforeach
                    </div>
