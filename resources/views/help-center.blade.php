    ...
    <div class="page">
        ...
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap"><a class="header__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
              <nav class="header__navigation"><a class="header__link" href="index.html">Dashboard</a><a class="header__link" href="wallets.html">Wallets</a><a class="header__link" href="settings.html">Settings</a><a class="header__link active" href="help-center.html">Help & Center</a></nav><a class="header__logout" href="login.html">Log Out</a>
          ...
          <div class="page__title">Help & Center</div>
          <div class="page__breadcrumbs"><a class="page__link" href="help-center.html">Help & Center</a>
            <svg class="icon icon-arrow-next">
              <use xlink:href="#icon-arrow-next"></use>
            </svg>
            <div class="page__text">How do make transaction</div>
          </div>
        </div>
      </div>
      <div class="page__body">
        <div class="container page__container">
          ...
          <div class="help">
            <div class="help__box">
              <div class="help__title">Hi, Can we help you ?</div>
              <div class="help__text">Type your question or search by keyword here here</div>
              <form class="search search_large" action="">
                <input class="search__input" type="text" name="search" placeholder="Search here" required="required"/>
                <button class="search__button">
                  <svg class="icon icon-search">
                    <use xlink:href="#icon-search"></use>
                  </svg>
              ...
              <div class="help__label">Popular Search</div>
              <div class="help__btns">
                <button class="button-stroke help__button">Transfer</button>
                <button class="button-stroke help__button">Change card</button>
                <button class="button-stroke help__button">Flow</button>
              </div>
            </div>
            <!-- card-->
            <div class="card">
              <div class="card__head">
                <div class="card__title">Frequently Asked Questions
              ...
              <div class="help__list">
                <div class="help__item">
                  <div class="help__subtitle">How do I make a payment transaction?</div>
                  <div class="help__content">Lorem ipsum dolor sit amet consectetur. Et nisi nisl tincidunt diam hendrerit etiam a. Volutpat maecenas sapien nunc quis lacus pretium faucibus cras. Sagittis diam suspendisse diam non non scelerisque turpis. Ipsum volutpat porttitor dui.</div>
                  <div class="help__line">
                    <div class="help__tags">
                      <div class="help__tag">Payment</div>
                      <div class="help__tag">Transaction</div>
                      <div class="help__tag">Send</div>
                    </div>
                    <button class="help__like">
