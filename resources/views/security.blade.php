      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="settings.html">Settings</a>
            ...
            <div class="page__text">Security</div>
          </div>
        </div>
      </div>
        ...
        <div class="container page__container">
          ...
          <div class="settings">
            <div class="settings__menu"><a class="settings__link" href="settings.html">
                ...
                <svg class="icon icon-arrow-next">
                  <use xlink:href="#icon-arrow-next"></use>
                </svg></a><a class="settings__link active" href="security.html">
                <div class="settings__icon">
            ...
            <div class="card">
              <div class="card__head">
                <div class="card__title">Security
              ...
              <form class="settings__form" action="">
                ...
                <div class="field field_password">
                  ...
                  <div class="field__wrap">
                    <input class="field__input" type="password" name="old-password" placeholder="Type old password" value="eeqw567891" required>
                ...
                <!-- field-->
                <div class="field field_password">
                  <div class="field__label">Repeat New Password</div>
                  <div class="field__wrap">
