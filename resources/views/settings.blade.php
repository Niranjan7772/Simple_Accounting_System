    ...
    <div class="page">
        ...
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap"><a class="header__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
              <nav class="header__navigation"><a class="header__link" href="index.html">Dashboard</a><a class="header__link" href="wallets.html">Wallets</a><a class="header__link active" href="settings.html">Settings</a><a class="header__link" href="help-center.html">Help & Center</a></nav><a class="header__logout" href="login.html">Log Out</a>
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="settings.html">Settings</a>
            <svg class="icon icon-arrow-next">
              <use xlink:href="#icon-arrow-next"></use>
            </svg>
            <div class="page__text">Personal Information</div>
          </div>
        </div>
      </div>
      <div class="page__body">
        <div class="container page__container">
          <!-- settings-->
          <div class="settings">
            <div class="settings__menu"><a class="settings__link active" href="settings.html">
                ...
                <svg class="icon icon-arrow-next">
                  <use xlink:href="#icon-arrow-next"></use>
                </svg></a><a class="settings__link" href="preferences.html">
                <div class="settings__icon">
                  <svg class="icon icon-preferences">
                    <use xlink:href="#icon-preferences"></use>
                  </svg>
                </div>Preferences
                <svg class="icon icon-arrow-next">
                  <use xlink:href="#icon-arrow-next"></use>
                </svg></a><a class="settings__link" href="security.html">
                <div class="settings__icon">
                ...
                <svg class="icon icon-arrow-next">
                  <use xlink:href="#icon-arrow-next"></use>
                </svg></a><a class="settings__link" href="login.html">
                <div class="settings__icon">
            ...
            <div class="card">
              <div class="card__head">
                <div class="card__title">Personal Information
              ...
              <form class="settings__form" action="">
                <div class="settings__photo">
                  <div class="settings__label">Photo Profile</div>
                  <div class="settings__control">
                    <div class="settings__avatar"><img src="img/content/avatar.jpg" alt="">
                      <svg class="icon icon-user">
                        <use xlink:href="#icon-user"></use>
                      </svg>
                    </div>
                    <div class="settings__file">
                      ...
                      <button class="button settings__button">Upload image</button>
                    </div>
                    <button class="button-stroke settings__delete">Delete
                      <svg class="icon icon-trash-stroke">
                        <use xlink:href="#icon-trash-stroke"></use>
                      </svg>
                    </button>
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="field__wrap">
                    <input class="field__input" type="text" name="display-name" placeholder="Type display name" value="Rainer Yaeger" required>
                  </div>
                </div>
                <!-- field-->
                <div class="field">
                  ...
                  <div class="field__wrap">
                    <input class="field__input" type="email" name="email" placeholder="Type email" value="yourname@gmail.com" required>
                  </div>
                </div>
                <!-- field-->
                <div class="field field_icon-after">
                  ...
                  <div class="field__wrap field__wrap_date">
                    <input class="field__input js-date-range" type="text" name="date" data-format="MM-DD-yyyy" data-single-month="true" data-single-date="true" data-container=".field__wrap_date" readonly>
                ...
                <div class="settings__row">
                  ...
                  <!-- field-->
                  <div class="field">
                    <div class="field__label">Province</div>
                    <!-- drop-->
                    <div class="drop drop_up js-drop">
                      <div class="drop__head js-drop-head">
                        <div class="drop__title js-drop-title"></div>
                      ...
                      <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#">
                          <div class="drop__text js-drop-text">Central Java</div></a><a class="drop__option js-drop-option" href="#">
                          <div class="drop__text js-drop-text">VIC</div></a></div>
                      <input class="drop__input js-drop-input" type="hidden" name="province">
                    </div>
                  </div>
                  <!-- field-->
                  <div class="field">
                ...
                <div class="settings__btns">
                  <button class="button-stroke settings__button">Cancel</button>
                  <button class="button settings__button">Yes</button>
                </div>
              </form>
            </div>
          </div>
