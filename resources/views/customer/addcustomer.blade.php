      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/customer"><i class="fa fa-arrow-left" aria-hidden="true" style="font-size: 17px;"></i></a>
            ...
            <div class="page__text">Add Customer</div>
          </div>
            ...
            <form method="post" action="{{ route('customer.store') }}">
                ...
                <div class="col-md-3 form-group">
                    <h5> <label for="mobile" class="fw-bold">Mobile</label></h5>
                     <input type="number" class="form-control @error('mobile') is-invalid @enderror" name="mobile" id="mobile" placeholder="Enter Mobile">
                   @error('mobile')
                   <span style="color: red">{{ $message }}</span>
                   @enderror
                </div>
