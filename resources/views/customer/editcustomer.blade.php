    ...
    <div class="page">
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/customer"><i class="fa fa-arrow-left" aria-hidden="true" style="font-size: 17px;"></i></a>
            <svg class="icon icon-arrow-next">
              <use xlink:href="#icon-arrow-next"></use>
            </svg>
            <div class="page__text">Edit Customer</div>
          </div>
            ...
            <form method="post" action="{{ route('customer.update',$customers->id) }}">
                ...
                <div class="col-md-3 form-group">
                 <h5> <label for="name" class="fw-bold">Name</label></h5>
                  <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Enter Name" value="{{ $customers->name }}">
                </div>
                @error('name')
                ...
                <div class="col-md-3 form-group">
                    <h5> <label for="email" class="fw-bold">Email</label></h5>
                     <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="Enter Email"  value="{{ $customers->email }}"><br>
                   </div>
                   @error('email')
                   <span style="color: red">{{ $message }}</span>
                   @enderror<br>
                ...
                <div class="col-md-3 form-group">
                    <h5> <label for="mobile" class="fw-bold">Mobile</label></h5>
                     <input type="number" class="form-control @error('mobile') is-invalid @enderror" name="mobile" id="mobile" placeholder="Enter Email"  value="{{ $customers->mobile }}"><br>
                   </div>
                   @error('mobile')
                   <span style="color: red">{{ $message }}</span>
                   @enderror<br>
                   ...
                   <div class="col-md-3 form-group">
                    <h5> <label for="address" class="fw-bold">Address</label></h5>
                   <textarea name="address"  class="form-control @error('address') is-invalid @enderror" rows="2">  {{ $customers->address }}</textarea>
                   </div>
                   @error('address')
                   <span style="color: red">{{ $message }}</span>
                   @enderror<br>
                <div class="col-md-4">
                <button type="submit" class="mt-5 btn btn-success">Update</button>
            </div>
              </form>
            </div>
