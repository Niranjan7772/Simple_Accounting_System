      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="index.html">Dashboard</a>
            ...
            <div class="page__text">Transaction</div>
          </div>
          <div class="page__line">
            <div class="page__nav"><a class="page__link" href="/d2">Overview</a><a class="page__link active" href="{{ route('transaction.index') }}">Transaction</a><a class="page__link" href="statistics.html">Statistics</a><a class="page__link" href="{{ route('users.index') }}">Users</a><a class="page__link" href="{{ route('accounts.index') }}">Accounts</a><a class="page__link" href="{{ route('expense.index') }}">Expense</a><a class="page__link" href="{{ route('budget.index') }}">Budget</a><a class="page__link" href="{{ route('customer.index') }}">Customer</a><a class="page__link" href="{{ route('invoice.index') }}">Invoice</a><a class="page__link" href="{{ route('audit.index') }}">Audit</a></div>
            ...
            <div class="mt-4 col-md-1">
                ...
                <table class="table table-striped" id="myTable">
                    <thead>
                        ...
                        <th style="font-size: 17px;">From</th>
                        <th style="font-size: 17px;">To</th>
                        <th style="font-size: 17px;">Name</th>
                        <th style="font-size: 17px;">Amount</th>
                        <th style="font-size: 17px;">Date & Time</th>
                    </thead>
                    <tbody >
                        @foreach ($data as $key => $row)
                            <tr>
                                ...
                                <td style="font-size: 17px;">{{ $row['from'] }}</td>
                                <td style="font-size: 17px;">{{ $row['to'] }}</td>
                                <td style="font-size: 17px;">{{ $userNames[$key] }}</td>
                                <td style="color: {{ $row['transaction'] == 0 ? 'red' : 'green' }}; font-size: 17px;">{{ $row['amount'] }}</td>
