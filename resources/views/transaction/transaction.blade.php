      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__line">
            <div class="page__nav">
                <div class="page__nav"><a class="page__link" href="{{ route('accounts.index') }}">Account</a><a class="page__link " href="{{ route('transfer.index') }}">Transfer</a><a class="page__link active" href="{{ route('transaction.index') }}">Transaction</a></div>
            </div>
