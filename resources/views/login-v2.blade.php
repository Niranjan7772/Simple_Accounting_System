...
<html lang="en">
  ...
  <body>
    <!-- login-->
    <div class="login login_v2">
      <div class="login__col_left"><img src="img/content/login-pic.jpg" alt=""></div>
      <div class="login__col_right">
        <div class="login__inner">
          <div class="login__wrap">
            <div class="login__top"><a class="login__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
              <div class="login__title">Welcome back to Findash</div>
              <div class="login__info">Let’s empower your financial task today with Findash.</div>
            </div>
