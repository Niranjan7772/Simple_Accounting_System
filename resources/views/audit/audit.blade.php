      ...
      <div class="page__head">
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap"><a class="header__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
              <nav class="header__navigation">
                ...
                <a class="header__link active" href="{{ route('audit.index') }}">Audit</a>
                @endif
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/d2">Dashboard</a>
            ...
            <div class="page__text">Audit</div>
          </div>
          <div class="page__line">
            <div class="page__nav">
                <div class="page__nav"><a class="page__link active" href="{{ route('audit.index') }}">Audit</a></div>
            </div>
