      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/budget"><i class="fa fa-arrow-left" aria-hidden="true" style="font-size: 17px;"></i></a>
            ...
            <div class="page__text">Add Budget</div>
          </div>
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <h5> <label for="start_date" class="fw-bold">Start Date</label></h5>
                     <input type="date" class="form-control @error('end_date') is-invalid @enderror" name="start_date" id="start_date" >
                     @error('start_date')
                     <span style="color: red">{{ $message }}</span>
                     @enderror
                   </div>
               ...
               <div class="col-md-3">
                ...
                <div class="col-md-5">
                <button type="submit" class="mt-5 btn btn-success">Add Budget</button>
            </div>
