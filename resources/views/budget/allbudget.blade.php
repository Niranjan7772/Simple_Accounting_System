      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/d2">Dashboard</a>
            ...
            <div class="page__text">Budget</div>
          </div>
          <div class="page__line">
            <div class="page__nav">
                <div class="page__nav"><a class="page__link" href="{{ route('expense.index') }}">Expense</a><a class="page__link active" href="{{ route('budget.index') }}">Budget</a></div>
            </div>
          ...
          <div class="transactions">
            ...
            <div class="mt-4 col-md-1">
                ...
                {{-- <div class="transactions"> --}}
                      ...
                      <div class="mb-4">
                    @if (Auth::user()->hasPermission('add_budget'))
                              <a class=" page__link"  href="{{ route('budget.create') }}"> <button class="btn btn-success"><i class="fas fa-hand-holding-usd"></i>Add Budget</button></a>
                    @endif
                </div>
                        ...
                        <tbody style="font-size: 17px">
                            ...
                            <tr>
                                ...
                                <td>{{ $budget->end_date }}</td>
                                 <td>{{ $budget->amount }}</td>
                                 <td>
                                    {{-- @if (Auth::user()->hasPermission('edit_budget')) --}}
                                <a href="{{ route('budget.edit',$budget->id) }}" type="button">
                                    <i class="fa fa-pencil-square-o" style="font-size:30px;color:green" ></i>
                                  </a>
                                    {{-- @endif
                                    @if (Auth::user()->hasPermission('delete_budget')) --}}
                                    <a type="button"  data-bs-toggle="modal" data-bs-target="#exampleModal{{ $budget->id }}" style="cursor: pointer;">
