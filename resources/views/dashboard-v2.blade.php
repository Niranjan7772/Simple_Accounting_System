  ...
  <body>
      ...
      <div class="page__head">
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap"><a class="header__logo" href="index.html">
              ...
              <nav class="header__navigation">
                ...
                <a class="header__link active" href="/d2">Dashboard</a>
                ...
                <a class="header__link" href="">
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit" style="color:#4a72c1;font-size:20px;">Logout</button>
                    </form>
            ...
            <div class="header__control">
              ...
              </div><a class="header__avatar" href="settings.html"><img src="img/content/avatar.jpg" alt=""></a>
            </div>
            <div class="header__overlay"></div> --}}
          </header>
          <div class="page__title">Welcome back,  {{ Auth::user()->name }} 👏🏻</div>
          ...
          <div class="page__line">
            <div class="page__nav"><a class="page__link active" href="/d2">Overview</a>
      ...
      <div class="page__body">
        <div class="container page__container">
          ...
          <div class="dashboard2">
            <div class="dashboard2__row">
              <div class="dashboard2__col" >
                <!-- card-->
                <div class="card"  >
                  <div class="card__head">
                    <div class="card__title">Total Balance
                    ...
                    <div class="card__right">
                      <!-- drop-->
                      <div class="drop drop_small js-drop">
                        <div class="drop__head js-drop-head">
                          <div class="drop__image"><img src="#" alt=""/></div>
                        ...
                        <div class="drop__body js-drop-body">
                            ...
                            <a class="drop__option js-drop-option selected" href="#">
                            {{-- <div class="drop__image"> --}}
                                {{-- <img src="img/content/master-card.svg" alt=""/> --}}
                            {{-- </div> --}}
                            <div class="drop__text js-drop-text" >Select Account</div></a>
                            ...
                            @foreach ( $user_accounts as $account)
                                ...
                                <div class="content" style="padding: 5px;">
                                    <a href="{{ route('dashboard.edit',$account->id) }}" type="button" style="color: black;">{{ $account->name }}</a>
                                </div>
                            ...
                            {{-- <a class="drop__option js-drop-option" href="#">
                            <div class="drop__image"><img src="img/content/master-card.svg" alt=""/></div>
                            <div class="drop__text js-drop-text">**** 1231</div></a><a class="drop__option js-drop-option" href="#">
                            <div class="drop__image"><img src="img/content/visa.svg" alt=""/></div>
                            <div class="drop__text js-drop-text">**** 5643</div></a> --}}


                        </div>
                        <input class="drop__input js-drop-input" type="hidden" name="card"/>
                      </div>
                    </div>
                  </div>
                  <div class="card__price">  @if (session()->has('actual_amt'))
                       Rs. {{ session()->get('actual_amt') }}
                       @else
                      Rs.  {{$actual_amt }}
                  ...
                  {{-- <div class="card__btns"><a class="button card__button js-popup-open" href="#popup-transfer" data-type="inline" data-effect="mfp-zoom-in">
                      <svg class="icon icon-transfer">
                        <use xlink:href="#icon-transfer"></use>
                      </svg>
                      <span>Transfer</span>
                    </a>
                      <a class="button card__button js-popup-open" href="#popup-receive" data-type="inline" data-effect="mfp-zoom-in">
                       <svg class="icon icon-receive">
                ...
                <div class="card">
                  <div class="card__head">
                    <div class="card__title">Recent Activity
                      <div class="tooltip" title="Small description">
                        <svg class="icon icon-info-circle">
                          <use xlink:href="#icon-info-circle"></use>
                        </svg>
                    ...
                    <div class="card__right">
                        <a class="card__more" href="/transaction">See more
                        <svg class="icon icon-arrow-thick-right">
                          <use xlink:href="#icon-arrow-thick-right"></use>
                        </svg></a>
                    </div>
                  </div>
                  <!-- activity-->
                  <div class="activity">
                    <div class="activity__item">
                      {{-- <div class="activity__logo"><img src="img/content/figma.png" alt=""/></div> --}}
                      <div class="activity__details">
                        <div class="activity__line">
                         {{-- <div class="activity__title">Figma Pro</div>
                          <div class="activity__price">-$23.21</div> --}}
                        </div>
                        <div class="activity__line">
                          {{-- <div class="activity__description">Subscriptions</div>
                          <div class="activity__time">15/02/22 - 12.34</div> --}}
                        </div>
                      </div>
                    </div>
                    {{-- <div class="activity__item">
                      <div class="activity__logo"><img src="img/content/adobe.png" alt=""/></div>
                      <div class="activity__details">
                        <div class="activity__line">
                          <div class="activity__title">Adobe Collection</div>
                          <div class="activity__price">-$50.21</div>
                        </div>
                        <div class="activity__line">
                          <div class="activity__description">Subscriptions</div>
                          <div class="activity__time">14/02/22 - 8.55</div>
                        </div>
                      </div>
                    </div> --}}
                    {{-- <div class="activity__item">
                      <div class="activity__logo"><img src="resources/img/content/fiver-inter.png" alt=""/></div>
                      <div class="activity__details">
                        <div class="activity__line">
                          <div class="activity__title">Fiver Inter</div>
                          <div class="activity__price">+$100.00</div>
                        </div>
                        <div class="activity__line">
                          <div class="activity__description">Receive</div>
                          <div class="activity__time">11/02/22 - 13.33</div>
                        </div>
                      </div>
                    </div> --}}
                    {{-- <div class="activity__item">
                      <div class="activity__logo"><img src="img/content/starbucks.png" alt=""/></div>
                      <div class="activity__details">
                        <div class="activity__line">
                          <div class="activity__title">Starbucks</div>
                          <div class="activity__price">-$50.00</div>
                        </div>
                        <div class="activity__line">
                          <div class="activity__description">Transfer</div>
                          <div class="activity__time">02/02/22 - 9.15</div>
                        </div>
                      </div>
                    </div> --}}
                    ...
                    <div class="activity__item">
                      {{-- <div class="activity__logo">
                        <img src="img/content/upwork-inter.png" alt=""/>
                    </div> --}}
                      <div class="activity__details">
                        <div class="activity__line">

                          <div class="activity__title">
                            @if($transaction->reference_type==2)Invoice
                            @elseif($transaction->reference_type==1)Expense
                            @elseif($transaction->reference_type==0)Transfer
                            @endif
                          </div>
                          <div class="activity__price">{{ $transaction->amount }}</div>
                        </div>
                        <div class="activity__line">
                          <div class="activity__description"></div>
                          <div class="activity__time">{{ $transaction->created_at->toDateString() }}</div>
                        </div>
                      </div>
                    </div>
                    @endforeach
              ...
              <div class="dashboard2__col">
                <!-- card-->
                <div class="card card_analysis">
                  <div class="card__head">
                    <div class="card__title">Income
                      {{-- <div class="tooltip" title="Small description">
                        <svg class="icon icon-info-circle">
                          <use xlink:href="#icon-info-circle"></use>
                        </svg>
                    ...
                    <div class="card__right" >
                      ...
                      <div class="drop drop_small js-drop">
                        ...
                        <div class="drop__body js-drop-body" >
                            {{-- <a class="drop__option js-drop-option selected" href="#">
                            <div class="drop__text js-drop-text">Monthly</div></a>
                            <a class="drop__option js-drop-option" href="#">
                            <div class="drop__text js-drop-text">Annually</div></a> --}}
                        </div>
                      </div>
                    </div>
                  </div>
                  <!-- analysis-->
                  <div class="analysis analysis_row"  >
                    <div class="analysis__details">
                      <div class="analysis__box">
                        <div class="analysis__price" style="color: #1c7867">
                            @if (session()->has('inc_amt'))
                            Rs. {{ session()->get('inc_amt') }}
                            @else
                           Rs.  {{$income_amt }}
                      ...
                      {{-- <div class="analysis__expense">Expense increased by <span>$2.172</span> This Month</div> --}}
                    </div>
                    {{-- <div class="analysis__chart analysis__chart_income">
                ...
                <div class="card card_analysis" >
                  ...
                  <div class="analysis analysis_row">
                    <div class="analysis__details">
                      <div class="analysis__box">
                        <div class="analysis__price" style="color: rgb(195, 18, 18)">

                            @if (session()->has('exp_amt'))
                       Rs. {{ session()->get('exp_amt') }}
                       @else
                      Rs. {{ $expense }}
                      ...
                      {{-- <div class="analysis__expense negative">Expense increased by <span>$1.456</span> This Month</div> --}}
                    </div>
                    {{-- <div class="analysis__chart analysis__chart_expense">
                ...
                <div class="card">
                  <div class="card__head">
                    ...
                    <div class="card__right">
                      ...
                      <div class="drop drop_small js-drop">
                        ...
                        <div class="drop__body js-drop-body">
                            {{-- <a class="drop__option js-drop-option selected" href="#">
                            <div class="drop__text js-drop-text">Monthly</div>
                        </a> --}}
                        {{-- <a class="drop__option js-drop-option" href="#">
                            <div class="drop__text js-drop-text">Annually</div>
                        </a> --}}
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="pie">
                    <div class="pie__inner">
                      {{-- <div class="pie__chart" id="expense-category"></div> --}}
                      <div class="pie__box">
                        {{-- {{-- <div class="pie__info">100%</div> --}}
                        <div class="pie__text">Reports</div>
                      </div>
                    </div>
                    <div class="pie__legend">
                      <div class="pie__item">
                        <div class="pie__color" style="background-color: #31B099"></div>
                        <div class="pie__title">Income</div>
                      ...
                      <div class="pie__item">
                        <div class="pie__color" style="background-color: #C65468"></div>
                        <div class="pie__title">Expense</div>
                        <div class="pie__value">
                      ...
                      <div class="pie__item">
                        <div class="pie__color" style="background-color: #E7854D"></div>
                        <div class="pie__title">Transfer Credit</div>
                        <div class="pie__value">
                            @if (session()->has('trans_money'))
                            Rs. {{ session()->get('trans_money') }}
                            @else
                           Rs.  {{$transfer_money }}
                      ...
                      <div class="pie__item">
                        <div class="pie__color" style="background-color: #4D81E7"></div>
                        <div class="pie__title">Transfer Debit</div>
                        <div class="pie__value">
                            @if (session()->has('trans_money_to'))
                            Rs. {{ session()->get('trans_money_to') }}
                            @else
                           Rs.  {{$transfer_money_to }}
              ...
              <div class="dashboard2__col">
                <div class="dashboard2__card">
                  <!-- card-->
                  {{-- <div class="card"> --}}
                    {{-- <div class="card__head"> --}}
                      {{-- <div class="card__title">My Pocket Plans
                        <div class="tooltip" title="Small description">
                          <svg class="icon icon-info-circle">
                            <use xlink:href="#icon-info-circle"></use>
                          </svg>
                      ...
                      {{-- </div> --}}
                      {{-- <div class="card__right"> --}}
                         {{-- <a class="card__more" href="#">See more
                          <svg class="icon icon-arrow-thick-right">
                            <use xlink:href="#icon-arrow-thick-right"></use>
                          </svg></a> --}}
                        {{-- </div> --}}
                    ...
                    {{-- <div class="plans"> --}}
                      {{-- <div class="plans__list">
                        <div class="plans__item">
                          <div class="plans__preview"><img src="img/content/car.png" alt=""/></div>
                          <div class="plans__title">New Car</div>
                          <div class="plans__price">$5.000,00</div>
                        </div> --}}
                        {{-- <div class="plans__item"> --}}
                          {{-- <div class="plans__preview"><img src="img/content/console.png" alt=""/></div>
                          <div class="plans__title">New Console</div>
                          <div class="plans__price">$1.324,22</div>
                        </div> --}}
                        {{-- <div class="plans__item"> --}}
                          {{-- <div class="plans__preview"><img src="img/content/money.png" alt=""/></div>
                          <div class="plans__title">Savings</div>
                          <div class="plans__price">$3.094,56</div> --}}
                        {{-- </div>
                        <div class="plans__item"> --}}
                          {{-- <div class="plans__preview"><img src="img/content/wedding-dress.png" alt=""/></div>
                          <div class="plans__title">Wedding Dress</div>
                          <div class="plans__price">$1191,68</div> --}}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="dashboard2__card">
                  ...
                  {{-- <div class="card"> --}}
                    {{-- <div class="card__head">
                      <div class="card__title">Currency
                        <div class="tooltip" title="Small description">
                          <svg class="icon icon-info-circle">
                            <use xlink:href="#icon-info-circle"></use>
                          </svg>
                        ...
                        {{-- <div class="card__box">
                          ...
                          <div class="drop drop_medium js-drop">
                            ...
                            {{-- <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#"> --}}
                                {{-- <div class="drop__text js-drop-text">USD</div></a><a class="drop__option js-drop-option" href="#">
                                <div class="drop__text js-drop-text">EUR</div></a><a class="drop__option js-drop-option" href="#">
                                <div class="drop__text js-drop-text">CNY</div></a><a class="drop__option js-drop-option" href="#">
                                <div class="drop__text js-drop-text">JPY</div></a></div> --}}
                            {{-- <input class="drop__input js-drop-input" type="hidden" name="currency"> --}}
                          {{-- </div> --}}
                        </div>
                      </div>
                    </div>
                    ...
                    {{-- <div class="currency">
                      <div class="currency__item">
                        <div class="currency__logo"><img src="img/content/rupiah.png" alt=""/></div>
                        <div class="currency__details">
                          <div class="currency__title">Rupiah</div>
                          <div class="currency__price">15425,15</div>
                          <div class="currency__description">IDR</div>
                        </div>
                      </div> --}}
                      {{-- <div class="currency__item">
                        <div class="currency__logo"><img src="img/content/euro.png" alt=""/></div>
                        <div class="currency__details">
                          <div class="currency__title">Euro</div>
                          <div class="currency__price">0,95</div>
                          <div class="currency__description">EUR</div>
                        </div>
                      </div> --}}
                      {{-- <div class="currency__item">
                        <div class="currency__logo"><img src="img/content/chinese-yuan.png" alt=""/></div>
                        <div class="currency__details">
                          <div class="currency__title">Chinese Yuan</div>
                          <div class="currency__price">7,06</div>
                          <div class="currency__description">CNY</div>
                        </div> --}}
                      </div>
                    </div>
                  </div>
    ...
    <div class="popup popup_transfer mfp-hide" id="popup-transfer">
        <div class="popup__head">
            <div class="popup__title">Send Money</div>
            <div class="popup__info">Please enter user information that you want to send money and enter ammount</div>
          </div>
      {{-- <div class="popup__head">
        <div class="popup__title">Send Money</div>
        <div class="popup__info">Please enter user information that you want to send money and enter ammount</div>
      ...
      <!-- contacts-->
      <div class="contacts">
        <form class="contacts__search" action="">
          <input class="contacts__input" type="text" name="contacts-search" placeholder="Recent Contact" required>
          <button class="contacts__result">
            <svg class="icon icon-search">
              <use xlink:href="#icon-search"></use>
            </svg>
          </button>
        ...
        <div class="contacts__list">
          <!-- swiper-->
          <div class="swiper swiper-contacts-three">
            <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class="contacts__item">
                                <div class="contacts__avatar"><img src="img/content/avatar-1.png" alt=""></div>
                                <div class="contacts__title">Bertold Brown</div>
                                <div class="contacts__login">@bertold
                                </div>
                              </div>
                            </div>
                            <div class="swiper-slide">
                              <div class="contacts__item">
                                <div class="contacts__avatar"><img src="img/content/avatar-2.png" alt=""></div>
                                <div class="contacts__title">Risa Reis</div>
                                <div class="contacts__login">@RReis
                                </div>
                              </div>
                            </div>
                            <div class="swiper-slide">
                              <div class="contacts__item">
                                <div class="contacts__avatar"><img src="img/content/avatar-3.png" alt=""></div>
                                <div class="contacts__title">Conny Lower</div>
                                <div class="contacts__login">@Conlow
                                </div>
                              </div>
                            </div>
                            <div class="swiper-slide">
                              <div class="contacts__item">
                                <div class="contacts__avatar"><img src="img/content/avatar-4.png" alt=""></div>
                                <div class="contacts__title">Levi Acker</div>
                                <div class="contacts__login">@Leviack
                                </div>
                              </div>
                            </div>
                            <div class="swiper-slide">
      ...
      <!-- field-->
      <div class="field">
        <div class="field__label">Choose methode</div>
        <div class="field__wrap">
          ...
          <div class="drop js-drop">
            ...
            <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#">
                <div class="drop__text js-drop-text">Visa Card ( ****  ***** **** 3456 )</div></a><a class="drop__option js-drop-option" href="#">
                <div class="drop__text js-drop-text">Master Card ( ****  ***** **** 1231 )</div></a><a class="drop__option js-drop-option" href="#">
                <div class="drop__text js-drop-text">Visa Card ( ****  ***** **** 5422 )</div></a></div>
            <input class="drop__input js-drop-input" type="hidden" name="methode">
          </div>
        </div>
      </div>
      <!-- field-->
      <div class="field field_icon-before">
        <div class="field__label">Enter ammount</div>
        <div class="field__wrap">
          <input class="field__input" type="text" name="amount" placeholder="Type ammount" required>
          <div class="field__icon">
            <svg class="icon icon-dollar-circle">
              <use xlink:href="#icon-dollar-circle"></use>
            </svg>
          </div>
        </div>
      </div>
      <button class="button-wide popup__button">Confirm</button>
    </div>
    <!-- popup-->
    <div class="popup popup_receive mfp-hide" id="popup-receive">
      <div class="popup__head">
        <div class="popup__title">Receive Money</div>
        <div class="popup__info">You can  request multiple payment from up to 20 people</div>
      </div>
      <!-- field-->
      <div class="field">
        <div class="field__label">inpur id or contact name</div>
        <div class="field__wrap">
          <input class="field__input" type="text" name="amount" placeholder="Type id or name" required>
        </div>
      </div>
      <!-- contacts-->
      <div class="contacts">
      ...
      <div class="field field_icon-before">
        ...
        <div class="field__wrap">
            <form method="POST" action="{{ route('transfer.store') }}">
                @csrf
           <h4> <label class="fw-bold">From</label><br></h4>
           <select class="field__input" type="text" name="from" placeholder="Sender account" required><br><br><br>
            <option  disabled selected> Select account</option>
              @foreach ($user_acc->accounts as $account)
              <option class="field__input" name="from_" value="{{ $account->id }}" required>{{ $account->name }}</option>
              @endforeach


    </select><br><br><br>

    <label class="fw-bold">To</label><br>
    <select class="field__input" name="to" required>
        <option disabled selected>Select account</option>
        ...
        @endforeach
            ...
            <input class="field__input @error('date') is-invalid @enderror" type="date" name="date" placeholder="" required><br><br><br>
            
            <label class="fw-bold">Description</label><br>
            <input class="field__input @error('description') is-invalid @enderror" type="text" name="description" placeholder="eg:food,clothes,etc.." required><br><br><br>

            <label class="fw-bold">Amount</label><br>
          <input class="field__input @error('amount') is-invalid @enderror" type="number" name="amount" placeholder="Type ammount" min="1" required>
          {{-- <div class="field__icon"> --}}
            {{-- <svg class="icon icon-dollar-circle">
              <use xlink:href="#icon-dollar-circle"></use>
            </svg> --}}
      ...
      <button class="button-wide popup__button" type="submit" >Confirm</button>
    </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Clone the initial options for the "To" dropdown
            var initialToOptions = Array.from(toDropdown.options);

            fromDropdown.addEventListener('change', function () {
                // Enable or disable the "To" dropdown based on the selected "From" account
                toDropdown.disabled = (this.value === "");

                // If a "From" account is selected, dynamically update the "To" dropdown options
                if (this.value !== "") {
                    // Remove all options from the "To" dropdown and add the initial options
                    toDropdown.innerHTML = '';
                    initialToOptions.forEach(function (option) {
                        toDropdown.add(option.cloneNode(true));
                    });

                    // Remove the selected "From" account from the "To" dropdown
    ...
    <script src="{{ asset('js/lib/tooltipster.bundle.min.js')}}"></script>
    <script src="{{ asset('js/lib/apexcharts.min.js')}}"></script>
    <script src="{{  asset('js/lib/scroll-lock.min.js')}}"></script>
