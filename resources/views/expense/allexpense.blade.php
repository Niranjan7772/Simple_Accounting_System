        ...
        <div class="container page__container">
          <header class="header">
            ...
            <div class="header__wrap">
                <a class="header__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="/d2">Dashboard</a>
            ...
            <div class="page__text">Expense</div>
          </div>
          <div class="page__line">
            <div class="page__nav">
                <a class="page__link active" href="{{ route('expense.index') }}">Expense</a>
                @if (Auth::user()->hasPermission('view_budget'))
                <a class="page__link" href="{{ route('budget.index') }}">Budget</a>
                @endif
            </div>
                 ...
                 <div class="row">
                    @if (Auth::user()->hasPermission('add_expense'))
                        <div class="mb-4 col md-1">
                            <a class="page__link"  href="{{ route('expense.create') }}"> <button class="btn btn-danger"><i class="fa fa-rupee" style="font-size:20px;margin-right:5px;"></i>Add Expense</button></a>
                        </div>
                        @endif
                 </div>
                ...
                <table class="table mt-3 table-striped" id="myTable">
                    ...
                    <tbody style="17px">
                           ...
                           <tr>
                                ...
                                <td><img width="50px" src="{{ asset('images/' . $expense->receipt) }}"></td>
                           </tr>
                           @endforeach
