          ...
          <div class="wallet">
            <div class="wallet__row">
              <div class="wallet__col">
                ...
                <div class="card">
                  <div class="card__head">
                    <div class="card__title">Card Details
                  ...
                  <form class="wallet__form" action="">
                    <!-- field-->
                    <div class="field">
                      <div class="field__label">Name on Card</div>
                      <div class="field__wrap">
                        <input class="field__input" type="text" name="name-on-card" placeholder="Type Name on Card" value="Rainer Yaeger" required>
                      </div>
                    </div>
                    <!-- field-->
                    <div class="field">
                      ...
                      <div class="field__wrap">
                        <input class="field__input" type="email" name="email" placeholder="Type Email Address" value="RainerYaeger@gmail.com" required>
                      </div>
                    </div>
                    <!-- field-->
                    <div class="field">
                      ...
                      <div class="field__wrap">
                        <input class="field__input" type="text" name="card-number" placeholder="Type Card Number" value="1234 -4325 - 5467 - 3456" required>
                      </div>
                    </div>
                    <div class="wallet__line">
                      <!-- field-->
                      <div class="field">
                        <div class="field__label">Expiry</div>
                        <div class="field__wrap field__wrap_date">
                          <input class="field__input js-date-range" type="text" name="expiry" data-format="MM/yyyy" data-single-month="true" data-single-date="true" data-container=".field__wrap_date" readonly>
                        </div>
                      </div>
                      <!-- field-->
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <input class="field__input" type="password" name="cvv" placeholder="Type CVV" value="123" required>
                        </div>
                      </div>
                    </div>
                    <!-- field-->
                    <div class="field">
                      ...
                      <!-- drop-->
                      <div class="drop drop_up js-drop">
                        ...
                        <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#">
                            <div class="drop__text js-drop-text">Indonesia</div></a><a class="drop__option js-drop-option" href="#">
                            <div class="drop__text js-drop-text">Ukraine</div></a><a class="drop__option js-drop-option" href="#">
                            <div class="drop__text js-drop-text">USA</div></a></div>
                        <input class="drop__input js-drop-input" type="hidden" name="country">
                      </div>
                    </div>
                    <div class="wallet__line">
                      <!-- field-->
                      <div class="field">
                        ...
                        <div class="drop drop_up js-drop">
                          ...
                          <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#">
                              <div class="drop__text js-drop-text">VIC</div></a><a class="drop__option js-drop-option" href="#">
                              <div class="drop__text js-drop-text">VIC 2</div></a></div>
                          <input class="drop__input js-drop-input" type="hidden" name="state">
                        </div>
                      </div>
                      <!-- field-->
                      <div class="field">
                        ...
                        <div class="drop drop_up js-drop">
                          ...
                          <div class="drop__body js-drop-body"><a class="drop__option js-drop-option selected" href="#">
                              <div class="drop__text js-drop-text">Semarang</div></a><a class="drop__option js-drop-option" href="#">
                              <div class="drop__text js-drop-text">New-York</div></a><a class="drop__option js-drop-option" href="#">
                              <div class="drop__text js-drop-text">Oslo</div></a></div>
                          <input class="drop__input js-drop-input" type="hidden" name="city">
                        </div>
                      </div>
                    </div>
                    <div class="wallet__btns">
                      <button class="button-stroke wallet__button">Cancel</button>
                      <button class="button wallet__button">Yes</button>
                    </div>
                  </form>
                </div>
              </div>
              <div class="wallet__col">
                ...
                <div class="card">
                  <div class="card__head">
                    <div class="card__title">Card Design
                      <div class="tooltip" title="Small description">
                        <svg class="icon icon-info-circle">
                          <use xlink:href="#icon-info-circle"></use>
                        </svg>
                  ...
                  <!-- credit-->
                  <div class="credit" style="background: linear-gradient(164.81deg, #2AAC95 19.8%, #76D1F7 95.93%)">
                  ...
                  <div class="wallet__control">
                    <button class="button-stroke button-wide wallet__button">Change Card Design</button>
                  </div>
                </div>
              </div>
            </div>
