...
<html lang="en">
  ...
  <body>
    <!-- login-->
    <div class="login login_v1">
      <div class="login__col_left">
        <div class="login__images">
          <div class="login__image"><img src="img/content/dashboard.png" alt=""></div>
          <div class="login__image"><img src="img/content/balance-card.png" alt=""></div>
        </div>
        <div class="login__details"><a class="login__logo" href="index.html"><img src="img/logo.svg" alt="Finlab"></a>
          <div class="login__title">Let’s empower your financial task today with Findash.</div>
          <div class="login__text">The one-stop platform for all financial management of small and medium-sized business.</div>
        </div>
      </div>
      <div class="login__col_right">
        <div class="login__inner">
          <div class="login__wrap">
            <form class="login__entry" action="">
              <div class="login__description">
                <div class="login__arrow"><img src="img/content/arrow.svg" alt=""></div>
                <div class="login__head">
                  <div class="login__title">Login First to Your Account</div>
                </div>
                <!-- field-->
                <div class="field">
                  <div class="field__label">Email</div>
                  <div class="field__wrap">
                    <input class="field__input" type="email" name="email" placeholder="Type email" required>
                  </div>
                </div>
                <!-- field-->
                <div class="field field_password">
                  ...
                  <div class="field__wrap">
                    <input class="field__input" type="password" name="password" placeholder="Type password" required>
                    <button class="field__view" type="button">
                      <svg class="icon icon-eye">
                        <use xlink:href="#icon-eye"></use>
                      </svg>
                      <svg class="icon icon-eye-slash">
                ...
                <div class="login__line">
                  ...
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox" checked><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__label">Remember me</span></span>
                  </label><a class="login__link" href="#">Forgot Password</a>
                </div>
                <button class="button-wide login__button">Login</button>
                <div class="login__foot">
                  <div class="login__note">Don’t have an account? <a class="login__link" href="#">Register Here</a></div>
                </div>
              </div>
            </form>
            <form class="login__registration" action="">
              <div class="login__description">
                <button class="login__back" type="button">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg>
                </button>
                <div class="login__head">
                  <div class="login__title">Create New Account</div>
                  <div class="login__info">Please register by filling in your personal data</div>
                </div>
                <!-- field-->
                <div class="field">
                  <div class="field__label">Full name</div>
                  <div class="field__wrap">
                    <input class="field__input" type="text" name="name" placeholder="Type full name" required>
                  </div>
                </div>
                <!-- field-->
                <div class="field">
                ...
                <button class="button-wide login__button">Continue</button>
                <div class="login__foot">
                  <div class="login__note">Already have an account?  <a class="login__link" href="#">Login</a></div>
                </div>
              </div>
            </form>
            <div class="login__password">
              <form class="login__box" action="">
                <div class="login__description">
                  ...
                  <div class="login__head">
                    ...
                    <div class="login__info">Input your email address account to receive a reset link</div>
                  </div>
                  <!-- field-->
                  <div class="field">
                    <div class="field__label">Email</div>
              ...
              <form class="login__box" action="">
                <div class="login__description">
                  ...
                  <div class="login__head">
                    <div class="login__title">Create New Password</div>
                    <div class="login__info">Send your email account to reset password & make new password</div>
                  </div>
                  <!-- field-->
                  <div class="field field_password">
                    <div class="field__label">New Password</div>
                    <div class="field__wrap">
                      <input class="field__input" type="password" name="new-password" placeholder="Type new password" required>
                      <button class="field__view" type="button">
                        <svg class="icon icon-eye">
                          <use xlink:href="#icon-eye"></use>
                        </svg>
                  ...
                  <div class="login__reliability">
                    <div class="login__info">Min 8 Characters with a combination of letters and numbers</div>
                    <div class="login__levels">
                      <div class="login__level login__level_3"><span></span><span></span><span></span><span></span></div>
                      <div class="login__text">Strong</div>
                    </div>
                  </div>
                  <!-- field-->
                  <div class="field field_password">
                    <div class="field__label">Repeat Password</div>
                    <div class="field__wrap">
                      <input class="field__input" type="password" name="repeat-password" placeholder="Type repeat password" required>
                      <button class="field__view" type="button">
                        <svg class="icon icon-eye">
                          <use xlink:href="#icon-eye"></use>
                        </svg>
              ...
              <form class="login__box" action="">
                <div class="login__description">
                  ...
                  <div class="login__head">
                    <div class="login__title">Password Sucessfully Reset</div>
                    <div class="login__info">Please check your email, and create your new password</div>
                  </div>
                  <button class="button-wide login__button">Login now</button>
                </div>
              </form>
            </div>
          </div>
          <div class="login__copyright">© 2022 Finlab. All rights reserved.</div>
        </div>
      </div>
    </div>
    <!-- scripts-->
