      ...
      <div class="page__head">
        <div class="container page__container">
          ...
          <div class="page__breadcrumbs"><a class="page__link" href="index.html">Dashboard</a>
            ...
            <div class="page__text">Statistics</div>
          </div>
          <div class="page__line">
            <div class="page__nav"><a class="page__link" href="index.html">Overview</a><a class="page__link" href="transaction.html">Transaction</a><a class="page__link active" href="statistics.html">Statistics</a></div>
            ...
            <div class="statistics__row">
              ...
              <div class="statistics__col">
                <div class="statistics__card">
                  ...
                  <div class="card">
                    <div class="card__head">
                      <div class="card__title">Balance Statistics
                        <div class="tooltip" title="Small description">
                          <svg class="icon icon-info-circle">
                            <use xlink:href="#icon-info-circle"></use>
                          </svg>
                    ...
                    <div class="card__chart card__chart_statistics">
                      <div id="balance-statistics"></div>
                    </div>
                  </div>
                </div>
                <div class="statistics__card">
                  ...
                  <div class="card">
                    <div class="card__head">
                      <div class="card__title">Last Transaction
                        <div class="tooltip" title="Small description">
                          <svg class="icon icon-info-circle">
                            <use xlink:href="#icon-info-circle"></use>
                          </svg>
                    ...
                    <div class="market">
                      <div class="market__table">
                                                <div class="market__row">
                                                  <div class="market__cell">
                                                    <div class="market__description">
                                                      <div class="market__logo"><img src="img/content/figma.png" alt=""></div>
                                                      <div class="market__details">
                                                        <div class="market__name">Figma Pro</div>
                                                        <div class="market__business">Software</div>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="market__cell">
                                                    <div class="market__date">October 20 , 2022</div>
                                                    <div class="market__time">01:32 PM</div>
                                                  </div>
                                                  <div class="market__cell">-$32.00</div>
                                                  <div class="market__cell">
                                                    <div class="market__status market__status_success">Success</div>
                                                  </div>
                                                </div>
                                                <div class="market__row">
                                                  <div class="market__cell">
                                                    <div class="market__description">
                                                      <div class="market__logo"><img src="img/content/fiver-inter.png" alt=""></div>
                                                      <div class="market__details">
                                                        <div class="market__name">Fiver International</div>
                                                        <div class="market__business">Freelance platform</div>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="market__cell">
                                                    <div class="market__date">November 01 , 2022</div>
                                                    <div class="market__time">01:32 PM</div>
                                                  </div>
                                                  <div class="market__cell">+$100.00</div>
                                                  <div class="market__cell">
                                                    <div class="market__status market__status_pending">Pending</div>
                                                  </div>
                                                </div>
                                                <div class="market__row">
                                                  <div class="market__cell">
                                                    <div class="market__description">
                                                      <div class="market__logo"><img src="img/content/adobe.png" alt=""></div>
                                                      <div class="market__details">
                                                        <div class="market__name">Adobe</div>
                                                        <div class="market__business">Software</div>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="market__cell">-$32.00</div>
                                                  <div class="market__cell">
                                                    <div class="market__status market__status_canceled">Canceled</div>
                                                  </div>
                                                </div>
                                                <div class="market__row">
                                                  <div class="market__cell">
